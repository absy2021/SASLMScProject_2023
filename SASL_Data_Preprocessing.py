...
if not os.path.exists("SASLData"):
    os.makedirs("SASLData")
if not os.path.exists("SASLData/train"):
    os.makedirs("SASLData3/train")
if not os.path.exists("SASLData/test"):
    os.makedirs("SASLData/test")
path = "train"
path1 = "SASLData3"
a = ['label']
